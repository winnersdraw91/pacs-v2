    ...
    <Card className="bg-gray-900 border-gray-700 p-4">
      <div className="space-y-4">
                ...
                {showMeasurementMenu && (
                  ...
                  >
                    <div className="p-2 space-y-1">
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.LENGTH ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
                        onClick={() => { handleToolChange(TOOL_NAMES.LENGTH); setShowMeasurementMenu(false); }}
                      >
                        Length
                      </button>
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.ANGLE ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
                        onClick={() => { handleToolChange(TOOL_NAMES.ANGLE); setShowMeasurementMenu(false); }}
                      >
                        Angle
                      </button>
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.BIDIRECTIONAL ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
                        onClick={() => { handleToolChange(TOOL_NAMES.BIDIRECTIONAL); setShowMeasurementMenu(false); }}
                      >
                        Bidirectional
                      </button>
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.PROBE ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
              ...
              <div className="relative">
                ...
                {showROIMenu && (
                  ...
                  >
                    <div className="p-2 space-y-1">
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.ROI ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
                        onClick={() => { handleToolChange(TOOL_NAMES.ROI); setShowROIMenu(false); }}
                      >
                        Rectangle ROI
                      </button>
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.ELLIPSE ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
                        onClick={() => { handleToolChange(TOOL_NAMES.ELLIPSE); setShowROIMenu(false); }}
                      >
                        Ellipse ROI
                      </button>
                      <button
                        className={`w-full text-left px-3 py-2 rounded text-gray-200 ${activeTool === TOOL_NAMES.CIRCLE ? 'bg-cyan-500 text-white' : 'hover:bg-gray-700'}`}
        ...
        {(renderingMode === '3D' || renderingMode === 'MIP') && (
          <motion.div
            className="relative w-full h-[600px] bg-gray-900 rounded-lg overflow-hidden shadow-xl flex items-center justify-center"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.3 }}
          >
